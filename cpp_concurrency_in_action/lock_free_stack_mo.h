// Code List 7.2, Page 196
// use loose memory order
#include <atomic>
#include <memory>
...
class lock_free_stack {
 private:
  ...
  std::shared_ptr<counted_node_ptr> head;

  void increse_head_count(counted_node_ptr& old_counter) {
